...
<template>
  <div
    v-if="!dismissed"
    class="mx-3 mt-3 flex items-center gap-2 rounded-xl bg-ink-200 px-3 py-2.5 text-xs text-ink-700"
  >
    <svg class="mt-0.5 h-3.5 w-3.5 shrink-0 text-pink-600" viewBox="0 0 24 24" fill="currentColor">
