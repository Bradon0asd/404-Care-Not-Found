...
<template>
  <div class="rounded-xl bg-ink-200 p-4">
    ...
    <p class="mb-3 text-xs text-ink-600">此處可以明確定義 Care Agent 不能做什麼<br />如果不確定可以套用範本內容</p>
    ...
    <div class="flex gap-2">
      ...
      <button type="button" class="flex-1 rounded-full bg-accent py-2 text-xs font-bold text-ink-950" @click="applyTemplate">
        範本內容
      </button>
    </div>
